...
import com.angelena.weatherapp.data.Channel;
...
public class YahooWeatherService {
    ...
    public YahooWeatherService(WeatherServiceCallback) {
        this.callback = callback;
    }

    public void refreshWeather(final String location){
        @SuppressLint("StaticFieldLeak") AsyncTask<String, Void, String> execute = new AsyncTask<String, Void, String>() {
            @Override
